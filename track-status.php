...
<html>
  <head>
    <title>Track Shipped Item Status</title>
  ...
  <body>
    ...
    <center>
      <br><br><h3 style="color:#a73fd3 ;font-size: 25px;font-weight: bold"><u>Track and Trace your Cargo/Courier</u></h3><br>
      ...
      <form action="track-result.php" method="post" name="form" id="form" >
                               ...
                               </form><span class="gentxt">Ex: IXM53533553 </span> 
    </center>     
  </body>
</html>